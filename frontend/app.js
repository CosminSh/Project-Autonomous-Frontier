import { GameAPI } from './api.js?v=0.5.3';
import { AuthManager } from './auth.js?v=0.5.3';
import { GameRenderer } from './renderer.js?v=0.5.3';
import { UIManager } from './ui.js?v=0.5.3';
import { TerminalHandler } from './terminal.js?v=0.5.3';
