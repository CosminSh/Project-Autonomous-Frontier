import { GameAPI } from './api.js?v=2.18';
import { AuthManager } from './auth.js?v=2.18';
import { GameRenderer } from './renderer.js?v=2.18';
import { UIManager } from './ui.js?v=2.18';
import { TerminalHandler } from './terminal.js?v=2.18';
