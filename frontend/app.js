import { GameAPI } from './api.js?v=0.5.2';
import { AuthManager } from './auth.js?v=0.5.2';
import { GameRenderer } from './renderer.js?v=0.5.2';
import { UIManager } from './ui.js?v=0.5.2';
import { TerminalHandler } from './terminal.js?v=0.5.2';
