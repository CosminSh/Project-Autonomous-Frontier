import { GameAPI } from './api.js?v=SOLAR_V1';
import { AuthManager } from './auth.js?v=SOLAR_V1';
import { GameRenderer } from './renderer.js?v=SOLAR_V1';
import { UIManager } from './ui.js?v=SOLAR_V1';
import { TerminalHandler } from './terminal.js?v=SOLAR_V1';
